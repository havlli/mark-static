...
The CLI writes a complete documentation project with pnpm, Svelte 5, SvelteKit, Tailwind CSS 4, Skeleton 4, Markdown rendering, search, theme variables, static deployment settings, and documentation validation.
...
- **One-command scaffold**: Run `pnpm dlx mark-static@latest init` or create a new directory with `pnpm dlx mark-static@latest my-docs`.
